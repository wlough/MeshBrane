...
int main(){
  ...
  //Input:
  cout << "Runge-Kutta Method for FDP Integration\n";
  cout << "Enter omega_0, omega, gamma, A:\n";
  ...
  RK(Ti,Tf,X10,X20,Nt);
  //Output:
  ofstream myfile("fdp.dat");
  myfile.precision(17);
  myfile << "# Forced Damped Pendulum - fdp\n";
  myfile << "# omega_0= " << omega_0 << " omega= " << omega
         << "    gamma= " << gam     << "     A= " << a_0 << endl;
  for(i=0;i<Nt;i++){
