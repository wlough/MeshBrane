...
# gives filename with function as rk3_{name in parenthesis}.cpp
...
gfortran -O2 -c  rksuite/rksuite.f
g++      -O2 rk3.cpp rk3_${forcecode[$force]}.cpp rksuite.o -o rk3  -lgfortran
./rk3 <<EOF
$k1 $k2 $k3 $k4
