...
class MeshViewer:
    ...
    def update_from_HalfEdgeMesh(self, halfEdgeMesh, update_connect_data=False):
        ...
        self.V = np.array(halfEdgeMesh.V)
    ...
    def get_fig_path(self):
        ...
        # image_name = f"{self.image_prefix}_{self.image_count:0>self.image_index_length}.{self.image_type}"
        image_name = f"{self.image_prefix}_{self.image_count:0{self.image_index_length}d}.{self.image_type}"
