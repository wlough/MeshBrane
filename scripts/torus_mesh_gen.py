...
def raw_mesh_gen(
    ...
    """Generate raw meshes without smoothing"""
    import sys
...
def mesh_gen_laplacian_smooth():
    ...
    # 3) Laplacian smoothing is applied to the mesh
    ...
    # image_dirs = [f"{output_dir}/temp_images_{num_faces:06d}" for num_faces in Nfaces]
