...
def generate_half_edge_mesh_plys_without_str(vf_ply_dir, he_ply_dir, use_binary=True, skip_strings_with=[]):
...
def generate_half_edge_mesh_plys_with_str(vf_ply_dir, he_ply_dir, use_binary=True, only_use_strings=[]):
    """Generates a half edge mesh ply in he_ply_dir for each vertex-face list
    ply in vf_ply_dir"""
    _vf_ply_files = glob.glob(vf_ply_dir + "/*.ply")
    vf_ply_files = []
