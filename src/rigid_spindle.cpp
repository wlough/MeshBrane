...
///////////////////////////////////////////////////////
// void SphericalSPB::set_parameters() {
//   printf("SphericalSPB::set_parameters\n");
//   RigidMesh::set_parameters();
//   if (parameters_["contact_radius"]) {
//     contact_radius_ = parameters_["contact_radius"].as<double>();
//   }
//   if (parameters_["wca_epsilon"]) {
...
// void SphericalSPB::set_global_sim_parameters() {

//   if ((*sim_parameters_)["bulk_viscosity"]) {
//     double mu = (*sim_parameters_)["bulk_viscosity"].as<double>();
//     linear_drag_coefficient_ = 6.0 * M_PI * mu * contact_radius_;
//     angular_drag_coefficient_ =
//         8.0 * M_PI * mu * contact_radius_ * contact_radius_ *
//         contact_radius_;
//   }
// }

// void SphericalSPB::init_sphere(Vec3d &xyz, double radius, int
// num_refinements) {
//   //   printf("RigidMesh::init_sphere\n");
//   MatrixMesh::init_icosohedron();
//   for (int refinement = 0; refinement < num_refinements; refinement++) {
//     refine_icososphere();
//   }

//   xyz_relative_V_ = radius * xyz_coord_V_;
//   xyz_frame_ = xyz;
//   rotation_matrix_frame_ = Eigen::Matrix3d::Identity();
//   update_coords_from_frame();
//   init_mesh();
// };

// void SphericalSPB::init_spb(Vec3d &center) {
//   //   printf("RigidMesh::init_sphere\n");
//   MatrixMesh::init_icosohedron();
//   for (int refinement = 0; refinement < num_refinements_; refinement++) {
//     refine_icososphere();
...
// void SphericalSPB::time_step(double dt) {
//   //   printf("RigidMesh::time_step\n");
//   xyz_frame_ += dt * force_ / linear_drag_coefficient_;
//   // Vec3d angular_velocity = torque_ / angular_drag_coefficient_;
//   // Eigen::AngleAxisd rotation(angular_velocity.norm() * dt,
//   //                            angular_velocity.normalized());
//   // Eigen::Matrix3d rotation_matrix = rotation.toRotationMatrix();
...
// void RigidSpindle::init_spherical_spbs() {
//   printf("RigidSpindle::init_spherical_spbs\n");
//   Vec3d xyz1 = 0.5 * length_ * axis_;
//   Vec3d xyz2 = -0.5 * length_ * axis_;

//   spb1_.init_sphere(xyz1, contact_radius1_, spb_refinements_);
//   spb2_.init_sphere(xyz2, contact_radius2_, spb_refinements_);
// }

// void RigidSpindle::set_parameters() {
//   printf("RigidSpindle::set_parameters\n");
//   spb1_.parameters_ = parameters_["spb1"];
//   spb2_.parameters_ = parameters_["spb2"];
//   spb1_.set_parameters();
//   spb2_.set_parameters();

//   // if (parameters_["contact_radius1"]) {
//   //   contact_radius1_ = parameters_["contact_radius1"].as<double>();
//   // }
//   // if (parameters_["contact_radius2"]) {
//   //   contact_radius2_ = parameters_["contact_radius2"].as<double>();
//   // }
//   // if (parameters_["wca_epsilon"]) {
//   //   wca_epsilon_ = parameters_["wca_epsilon"].as<double>();
//   // }
...
//   //   wca_sigma_ = parameters_["wca_sigma"].as<double>();
//   // }
//   // if (parameters_["spb_refinements"]) {
//   //   spb_refinements_ = parameters_["spb_refinements"].as<int>();
//   // }
//   // if (parameters_["spb_linear_drag_coefficient"]) {
//   //   spb1_.linear_drag_coefficient_ =
//   //       parameters_["spb_linear_drag_coefficient"].as<double>();
//   //   spb2_.linear_drag_coefficient_ =
//   //       parameters_["spb_linear_drag_coefficient"].as<double>();
//   // }

//   // double wca_r_cutoff = std::pow(2.0, 1.0 / 6.0) * wca_sigma_;
//   // interaction_radius1_ = contact_radius1_ + wca_r_cutoff;
//   // interaction_radius2_ = contact_radius2_ + wca_r_cutoff;
...
// void RigidSpindle::set_global_sim_parameters() {

//   spb1_.sim_parameters_ = sim_parameters_;
//   spb2_.sim_parameters_ = sim_parameters_;
//   spb1_.set_global_sim_parameters();
//   spb2_.set_global_sim_parameters();

//   // if ((*sim_parameters_)["bulk_viscosity"]) {
//   //   double mu = (*sim_parameters_)["bulk_viscosity"].as<double>();
//   //   spb1_.linear_drag_coefficient_ = 6.0 * M_PI * mu * contact_radius1_;
//   //   spb2_.linear_drag_coefficient_ = 6.0 * M_PI * mu * contact_radius2_;
//   //   spb1_.angular_drag_coefficient_ = 8.0 * M_PI * mu * contact_radius1_ *
//   //                                     contact_radius1_ * contact_radius1_;
//   //   spb2_.angular_drag_coefficient_ = 8.0 * M_PI * mu * contact_radius2_ *
//   //                                     contact_radius2_ * contact_radius2_;
//   // }
...
// void RigidSpindle::apply_forces_to_spbs() {
//   if (overlap_length_ > 0.0) {
//     Vec3d F = motor_force_per_length_ * overlap_length_ * axis_;
//     spb1_.force_ += F;
//     spb2_.force_ -= F;
//   }
//   spb1_.sum_force_V();
...
// void RigidSpindle::grow(double dt) {
//   //   printf("RigidSpindle::grow\n");
//   // double delta_length = 2 * v_grow_ * dt;
//   // printf("deltaL = %f\n", delta_length);
//   if (overlap_length_ < length_) {
//     overlap_length_ += 2 * v_grow_ * dt;
//   }
// }

// void RigidSpindle::update_lengths() {
//   //   printf("RigidSpindle::update_lengths\n");
//   double length0 = length_;
//   double overlap_length0 = overlap_length_;
//   Vec3d x1 = spb1_.xyz_frame_;
//   Vec3d x2 = spb2_.xyz_frame_;
//   Vec3d dx = x1 - x2;
...
//     axis_ = dx / dx_norm;
//   } else {
//     // axis_ = Vec3d(0.0, 0.0, 1.0);
//     printf("Spindle length is zero. Not updating axis.\n");
//   }
//   double delta_length = length_ - length0;
//   overlap_length_ = overlap_length0 - delta_length;
//   // printf("deltaL = %f\n", -delta_length);
// }

// void RigidSpindle::time_step(double dt) {
//   //   printf("RigidSpindle::time_step\n");
//   // apply_forces_to_spbs();
//   spb1_.time_step(dt);
//   spb2_.time_step(dt);
//   grow(dt);
//   // Vec3d x1 = spb1_.xyz_frame_;
