...
class FancyMayaviVectorField:
    ...
    rgba : np.ndarray, optional
        An Nx4 array of rgba values. If None, the default color is orangish.
    name : str, optional
    ...
    rgba : np.ndarray
        An Nx4 array of rgba values. between 0 and 1.
    rgba_int : np.ndarray
        An Nx4 array of rgba values. between 0 and 255.
    color_scalars : np.ndarray
        An array of scalars for coloring the vectors.
    clamping : bool
        Whether to clamp the vectors. Default is False.
    tip_length : float
        The length of the vector tips. Default is 0.25.
    tip_radius : float
        The radius of the vector tips. Default is 0.03.
    shaft_radius : float
